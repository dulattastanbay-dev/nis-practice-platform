const I18N = {
  en: {
    ...
    'review.cropTop': "Crop from top",
    'review.cropBottom': "Crop to",
    'review.cropReset': "Show whole page",
    'review.err.bad_crop': "The crop window is too small or out of range.",
    'review.err.unknown_image': "That figure does not belong to this question.",
  ...
  kk: {
    ...
    'review.cropTop': "Жоғарыдан қиық",
    'review.cropBottom': "Дейін қиық",
    'review.cropReset': "Бүкіл бетті көрсету",
    'review.err.bad_crop': "Қиық терезесі тым кішкентай немесе ауқымнан тыс.",
    'review.err.unknown_image': "Бұл сурет осы сұраққа тиесілі емес.",
  ...
  ru: {
    ...
    'review.cropTop': "Обрезка сверху",
    'review.cropBottom': "Обрезка до",
    'review.cropReset': "Показать всю страницу",
    'review.err.bad_crop': "Область обрезки слишком мала или вне диапазона.",
    'review.err.unknown_image': "Это изображение не относится к данному вопросу.",
